...
intro: |-
  ...
  Since september 2025, I am a postdoctoral researcher at the Laboratoire de Psychologie et NeuroCognition (LPNC, Grenoble) under the supervision of [Nathan Faivre](https://nfaivre.netlify.app/#head) and as part of the VOLTA project, to investigates the electrochemical and electrophysiological correlates of subjective experience and its temporal dynamics. Within this framework, my research aims to bridge cognitive, electrophysiological, and electrochemical levels of explanation to better understand the temporal dynamics of conscious experience.

  In the longer term, I aim to develop my own research line on the multiscale mechanisms of temporal cognition, bridging behavioral, electrophysiological, and electrochemical levels of explanation. The objective is to build a unified framework of temporal cognition that captures how we understand, feel and represent subjective duration (on the subsecond scale), both in typical development and in conditions such as Parkinson’s disease, schizophrenia, and ADHD.
